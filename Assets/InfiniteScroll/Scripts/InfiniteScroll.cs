...
namespace UI.InfiniteScroll
{
    ...
    public class InfiniteScroll : MonoBehaviour, IBeginDragHandler, IDragHandler, IScrollHandler
    {
        ...
        private void DebugHorizontal(float cellLeftPoint, float cellRightPoint, float rightXThreshold,
            float leftXThreshold)
        {
        ...
        private void DebugVertical(float cellBottomPoint, float cellTopPoint, float topYThreshold,
            float bottomYThreshold)
        {
            var position = debugCellBottom.position;
            position =
